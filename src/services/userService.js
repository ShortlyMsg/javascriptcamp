...
export default class UserService{
    ...
    checkCustomerValidityForErrors(user){
        let reqiuredFields = "id firstName lastName age city".split(" ")
        let hasErrors = false
        for (const field of reqiuredFields) {
            if(!user[field]){
                hasErrors = true
    ...
    checkEmployeeValidityForErrors(user){
        let reqiuredFields = "id firstName lastName age city salary".split(" ")
        let hasErrors = false
        for (const field of reqiuredFields) {
            if(!user[field]){
                hasErrors = true
